defmodule PokerPlanWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PokerPlanWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PokerPlanWeb.Gettext, "errors", msg, opts)
    end
  end
