defmodule PokerPlanWeb.UserAuth do
      ...
      %{"user_id" => user_id} ->
        {
          ...
          Phoenix.Component.assign_new(socket, :current_user, fn ->
            PokerPlan.Repo.get!(PokerPlan.Users.User, user_id)
          end)
        }
  ...
  def on_mount(:ensure_authenticated, _params, session, socket) do
    ...
    case session do
      %{"user_id" => user_id} ->
        ...
        %PokerPlan.Users.User{} = new_socket.assigns.current_user
        {:cont, new_socket}
  ...
  def log_out_user(conn) do
    if live_socket_id = get_session(conn, :live_socket_id) do
      PokerPlanWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  def fetch_current_user(conn, _opts) do
    ...
    user = user_id && PokerPlan.Repo.get!(PokerPlan.Users.User, user_id)
  ...
  def signed_in_path(conn) do
    PokerPlanWeb.CoreComponents.profile_path(conn.assigns.current_user)
  end
end
