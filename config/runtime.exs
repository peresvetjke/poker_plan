...
#
#     PHX_SERVER=true bin/poker_plan start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :poker_plan, PokerPlanWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  ip =
    (System.get_env("PHX_IP") || "0.0.0.0")
    |> String.split(".")
    |> Enum.map(&String.to_integer(&1))
    |> List.to_tuple()

  host = System.get_env("PHX_IP") || "localhost"
  ...
  #
  #     config :poker_plan, PokerPlan.Mailer,
